...
var Track = function(row, artists, albums, genres) {
  ...
  this.albumArtist = this.albumArtistId ? artists[this.albumArtistId].name : "";
  this.sortAlbumArtist = this.albumArtistId ? artists[this.albumArtistId].sortName : this.sortArtist;
