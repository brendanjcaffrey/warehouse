...
LocalConfig = Struct.new(:music_path, :artwork_path, :bundles_path, :database_host, :database_port, :database_username, :database_password, :database_name, :update_library, :secret, :port, keyword_init: true)
RemoteConfig = Struct.new(:base_url, :music_path, :artwork_path, :bundles_path, :database_host, :database_port, :database_username, :database_password, :database_name, :update_library, :secret, :socket_path, keyword_init: true)
